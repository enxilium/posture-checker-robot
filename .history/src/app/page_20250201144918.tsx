...
export default function Home() {
	...
	<Balancer>
		An innovative open-source posture detection robot that leverages AI to monitor and improve your posture in real-time. Built with Next.js 14, TypeScript, and Tailwind CSS, it offers a seamless user experience while helping you maintain a healthy posture.
	</Balancer>
</p>
