...
export default function Home() {
	...
	<Balancer>
		An innovative open-source posture detection robot that leverages AI to monitor and improve your posture in real-time. Built wit offers a seamless user experience while helping you maintain a healthy posture.
	</Balancer>
</p>
